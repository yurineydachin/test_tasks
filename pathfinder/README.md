Fast test and simple of use you may see in index.php file. There is format of input set of boarding cards and example how to use one of path finder algorithm.
